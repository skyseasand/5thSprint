...
func (w Walking) Calories() float64 {
	...
	calories := ((CaloriesWeightMultiplier * w.Weight) +
		((math.Pow(speedMps, 2) / (w.Height / CmInM)) * CaloriesSpeedHeightMultiplier * w.Weight)) *
...
// TrainingInfo возвращает информацию о тренировке в формате InfoMessage.
// Переопределенный метод для Swimming{}.
